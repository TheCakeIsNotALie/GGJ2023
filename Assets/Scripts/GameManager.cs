...
public class GameManager : MonoBehaviour
{
    ...
    private void CalculateHydratation() {
        ...
        HashSet<WaterPocketBehavior> connectedWaterPockets =  rootController.GetConnectedWaterPockets();
        ...
        foreach (GameObject go in waterPockets) {
            WaterPocketBehavior waterPocketBehavior = go.GetComponent<WaterPocketBehavior>();
            if (connectedWaterPockets.Contains(waterPocketBehavior)) {
                hydratationActual += waterPocketBehavior.waterQuantity;
            }
        }
